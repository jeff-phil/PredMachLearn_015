...
Prediction results against the validation dataset are good, at nearly 99% accuracy, and the OOB out of sample error error rate: 1.69% based on Randdom Forest model using Traincontrol cross-validation function.
